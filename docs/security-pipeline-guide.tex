...
\begin{itemize}
  ...
  \item login remains available when only the two web credential variables are configured; and
...
npm test
\end{lstlisting}
The expected result is \texttt{tests 7}, \texttt{pass 7}, \texttt{fail 0}.
